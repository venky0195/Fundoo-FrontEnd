      ...
      <div >
            ...
            <Fade {...TransitionProps} timeout={350}>
              <Paper id="papperlogout">
                <ClickAwayListener onClick={this.handleToggle}>
                  <div className="popperMain" style={{ width: "250px", padding: "5px", marginTop: "14px", textAlign: "center" }}>
                    <div id="userProfileDetails">
                      ...
                      <p style={{ marginBottom: "0px" }}>{firstName}<br></br> </p>
        ...
        <div className="iconButton">
          ...
          <Tooltip
            ...
            <Avatar style={{ width: "40px", height: "40px" }} onClick={this.handleClick('bottom-end')} >
              {this.state.profilePic !== "" ?
                <img style={{
